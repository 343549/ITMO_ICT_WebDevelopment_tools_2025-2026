...
Отчёт и описание лабораторной — в папке `docs/`, конфиг: `mkdocs.yml`.
...
Сборка статического сайта (для GitHub Pages / PR):

```bash
.venv\Scripts\mkdocs.exe build
```

Полная документация: `docs/index.md` и разделы в навигации MkDocs.
